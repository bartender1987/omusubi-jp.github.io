...
{document.write('<object id="id4" type="video/quicktime" width="300" height="316" style="height: 316px; left: 200px; position: absolute; top: 86px; width: 300px; z-index: 1; "><param name="src" value="6_tiao_mu_2_files/podcast_entry_300x300-13.jpg"/><param name="target" value="myself"/><param name="href" value="../../../../../Media/podcast_entry_300x300.mp4"/><param name="controller" value="true"/><param name="scale" value="tofit"/></object>');}
else
...
{return false;}
function onPageLoad()
{dynamicallyPopulate();loadMozillaCSS('6_tiao_mu_2_files/6_tiao_mu_2Moz.css')
